...
Revision ID: a9ab90b1311d
Revises: 
Create Date: 2020-08-06 01:19:56.574371
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('delivery_time_placed', sa.DateTime(), nullable=False),
    sa.Column('delivery_time_actual', sa.DateTime(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('delivery_time_actual'),
    sa.UniqueConstraint('delivery_time_placed')
    )
